<html>
    ...
    <body>
       <div class="container-fluid">
        ...
        <div class="container-fluid">
              <div class="row under-slider-part">
                <div class="col-sm-3 footer-inner-1">
                    <div class="under-slider-part-1">
                        <div><img src="images/classrooms.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Classrooms</div>
                    </div>
                </div>
                <div class="col-sm-3 footer-inner-2">
                    <div class="under-slider-part-1">
                        <div><img src="images/lab2.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Labs</div>
                    </div>
                </div>
                <div class="col-sm-3 footer-inner-3">
                    <div class="under-slider-part-1">
                        <div><img src="images/results.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Results</div>
                    </div>
                </div>
                <div class="col-sm-3 footer-inner-4">
                    <div class="under-slider-part-1">
                        <div><img src="images/creativity.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Activities</div>
                    </div>
                </div>
              </div>
        </div>
        <div class="container-fluid">
              <div class="row under-slider-part">
                <div class="col-sm-3 footer-inner-1">
                    <div class="under-slider-part-1">
                        <div><img src="images/science.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Science</div>
                    </div>
                </div>
                <div class="col-sm-3 footer-inner-2">
                    <div class="under-slider-part-1">
                        <div><img src="images/art.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Art</div>
                    </div>
                </div>
                <div class="col-sm-3 footer-inner-3">
                    <div class="under-slider-part-1">
                        <div><img src="images/dance.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Dance</div>
                    </div>
                </div>
                <div class="col-sm-3 footer-inner-4">
                    <div class="under-slider-part-1">
                        <div><img src="images/activity.jpg" height="80%" width="100%" alt="Delta English School" /></div>
                        <div class="field" id="field">Sports</div>
                    </div>
                </div>
              </div>
        </div>
                ...
                <div class="col-sm-3 footer-inner-2"><h5 style="color:#F07114;font-weight:bold">Visit Here:</h5>
                    <ul>
                       <li><a href="index.php">Home</a></li>
                        ...
                        <button class="contactbtn"><a href="pay.php" style="text-decoration:none;color:black">Visit for payment Here</a></button>
