<html>
    ...
    <body>
        ...
        <div class="part0">Video Gallery</div>
        <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6 videoholder">
                    <iframe width="100%" height="300" src="https://www.youtube.com/embed/DWs9l5-trJg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col-sm-6 videoholder">
                     <iframe width="100%" height="300" src="https://www.youtube.com/embed/5xifQhU9Phw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
              </div>
        </div>
         <div class="container-fluid">
              <div class="row">
                <div class="col-sm-6 videoholder">
                   <iframe width="100%" height="300" src="https://www.youtube.com/embed/iRydNIzhzBM" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <div class="col-sm-6 videoholder">
                    <iframe width="100%" height="300" src="https://www.youtube.com/embed/zRjxIjNjCIU" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
              </div>
        </div>
